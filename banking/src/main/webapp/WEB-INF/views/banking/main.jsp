...
<body>
	...
	<form action="login" method="post">
		...
		<button type="button" onclick="location.href='<c:url value="transfer"/>' ">이체하기</a></button>
		<button type="button" onclick="location.href='<c:url value="transfer"/>' ">입금하기</a></button>
</body>
</html>